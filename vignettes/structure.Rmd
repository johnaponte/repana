...
WARNING: The clean_structure() function will delete directories listed
...
the information in the config.yml file. Refer to the [Database
configuration]
(<https://johnaponte.github.io/repana/articles/database.html> for more
information) Vignette for detailed instructions on setting up and using
the connection.
...
Your new project is ready.
  ...
  6. Share the config.yml file to your collaborators so they can adapt to their
  local conditions of the project. The config.yml is included in .gitignore and
...
information that should not be uploaded to GitHub. This directory may be 
